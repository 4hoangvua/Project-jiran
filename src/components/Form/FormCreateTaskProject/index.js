...
const FormCreateTaskProject = () => {
  ...
  useEffect(() => {
    if (allProject.length > 0) dispatch(getUserByProjectId(allProject[0].id));
    form.setFieldsValue({
      listUserAsign: [],
      taskName: "",
...
export default FormCreateTaskProject;
